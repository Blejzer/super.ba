...
public class FetchDataService extends IntentService {
    ...
    private static final String ACTION_FOO = "info.bdslab.android.asuper.action.FOO";
    private static final String ACTION_BAZ = "info.bdslab.android.asuper.action.BAZ";
